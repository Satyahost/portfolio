                ...
                {index % 2 === 0 && (
                  <div className="w-full max-w-md p-6 rounded-2xl bg-gray-900 border border-white shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] hover:scale-105 transition text-left">
                    ...
                    <a
                      ...
                      className="mt-5 inline-block w-full sm:w-auto text-center bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg font-semibold transition"
                    >
                      View Certificate
                    </a>
            ...
            <div className="sm:hidden w-full mt-4">
              <div className="p-5 rounded-2xl bg-gray-900 border border-white shadow-[0_0_20px_1px_rgba(130,69,236,0.3)]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-5 block w-full text-center bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg font-semibold transition"
                >
                  View Certificate
                </a>
