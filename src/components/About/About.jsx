      ...
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        ...
        <div className='md:w-1/2 text-center md:text-left mt-8 md:mt-0'>
          ...
          <p className='text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed'>
            ...
            in building scalable web applications. Skilled in both front-end
            and back-end development, I specialize in the MERN stack and
        ...
        <div className='md:w-1/2 flex justify-center md:justify-end'>
          <Tilt
            className='w-40 h-40 sm:w-52 sm:h-52 md:w-[25rem] md:h-[25rem] border-4 border-purple-700 rounded-full'
            tiltMaxAngleX={20}
            tiltMaxAngleY={20}
            perspective={1000}
            scale={1.05}
